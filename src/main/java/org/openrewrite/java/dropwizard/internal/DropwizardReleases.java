...
public class DropwizardReleases {
    ...
    public Stream<ModuleDownload> download(String version) {
        List<String> denyList = Arrays.asList("docs");

        Request request = new Request.Builder()
                .url(repositoryUrl + "/io/dropwizard")
                .build();
                ...
                return modules.stream()
                        .map(module -> {
                            Request moduleRequest = new Request.Builder()
                                    .url(repositoryUrl + "/io/dropwizard/" + module + "/" + version +
                                            "/" + module + "-" + version + ".jar")
                                    .build();
    ...
    public Set<String> allReleases() {
        if (availableReleases == null) {
            Request request = new Request.Builder()
                    .url(repositoryUrl + "/io/dropwizard/dropwizard-parent")
                    .build();
